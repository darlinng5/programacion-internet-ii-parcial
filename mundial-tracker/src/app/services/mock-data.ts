...
export const MOCK_TEAMS: Team[] = [
  // Grupo A
  { id: 1,  name: 'México',       code: 'MEX', flag: '🇲🇽', group: 'A', confederation: 'CONCACAF' },
  { id: 2,  name: 'Ecuador',      code: 'ECU', flag: '🇪🇨', group: 'A', confederation: 'CONMEBOL' },
  { id: 3,  name: 'Nigeria',      code: 'NGA', flag: '🇳🇬', group: 'A', confederation: 'CAF' },
  { id: 4,  name: 'Azerbaiyán',   code: 'AZE', flag: '🇦🇿', group: 'A', confederation: 'UEFA' },
  // Grupo B
  { id: 5,  name: 'Francia',      code: 'FRA', flag: '🇫🇷', group: 'B', confederation: 'UEFA' },
  { id: 6,  name: 'Argentina',    code: 'ARG', flag: '🇦🇷', group: 'B', confederation: 'CONMEBOL' },
  { id: 7,  name: 'Marruecos',    code: 'MAR', flag: '🇲🇦', group: 'B', confederation: 'CAF' },
  { id: 8,  name: 'Arabia Saudita', code: 'KSA', flag: '🇸🇦', group: 'B', confederation: 'AFC' },
  // Grupo C
  { id: 9,  name: 'Brasil',       code: 'BRA', flag: '🇧🇷', group: 'C', confederation: 'CONMEBOL' },
  { id: 10, name: 'Alemania',     code: 'GER', flag: '🇩🇪', group: 'C', confederation: 'UEFA' },
  { id: 11, name: 'Japón',        code: 'JPN', flag: '🇯🇵', group: 'C', confederation: 'AFC' },
  { id: 12, name: 'Suiza',        code: 'SUI', flag: '🇨🇭', group: 'C', confederation: 'UEFA' },
  // Grupo D
  { id: 13, name: 'España',       code: 'ESP', flag: '🇪🇸', group: 'D', confederation: 'UEFA' },
  { id: 14, name: 'Colombia',     code: 'COL', flag: '🇨🇴', group: 'D', confederation: 'CONMEBOL' },
  { id: 15, name: 'Senegal',      code: 'SEN', flag: '🇸🇳', group: 'D', confederation: 'CAF' },
  { id: 16, name: 'Corea del Sur', code: 'KOR', flag: '🇰🇷', group: 'D', confederation: 'AFC' },
  // Grupo E
  { id: 17, name: 'Inglaterra',   code: 'ENG', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', group: 'E', confederation: 'UEFA' },
  { id: 18, name: 'Portugal',     code: 'POR', flag: '🇵🇹', group: 'E', confederation: 'UEFA' },
  { id: 19, name: 'Uruguay',      code: 'URU', flag: '🇺🇾', group: 'E', confederation: 'CONMEBOL' },
  { id: 20, name: 'Ghana',        code: 'GHA', flag: '🇬🇭', group: 'E', confederation: 'CAF' },
  // Grupo F
  { id: 21, name: 'Estados Unidos', code: 'USA', flag: '🇺🇸', group: 'F', confederation: 'CONCACAF' },
  { id: 22, name: 'Países Bajos', code: 'NED', flag: '🇳🇱', group: 'F', confederation: 'UEFA' },
  { id: 23, name: 'Australia',    code: 'AUS', flag: '🇦🇺', group: 'F', confederation: 'AFC' },
  { id: 24, name: 'Costa Rica',   code: 'CRC', flag: '🇨🇷', group: 'F', confederation: 'CONCACAF' },
  // Grupo G
  { id: 25, name: 'Italia',       code: 'ITA', flag: '🇮🇹', group: 'G', confederation: 'UEFA' },
  { id: 26, name: 'Chile',        code: 'CHI', flag: '🇨🇱', group: 'G', confederation: 'CONMEBOL' },
  { id: 27, name: 'Irán',         code: 'IRN', flag: '🇮🇷', group: 'G', confederation: 'AFC' },
  { id: 28, name: 'Escocia',      code: 'SCO', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', group: 'G', confederation: 'UEFA' },
  // Grupo H
  { id: 29, name: 'Bélgica',      code: 'BEL', flag: '🇧🇪', group: 'H', confederation: 'UEFA' },
  { id: 30, name: 'Perú',         code: 'PER', flag: '🇵🇪', group: 'H', confederation: 'CONMEBOL' },
  { id: 31, name: 'Camerún',      code: 'CMR', flag: '🇨🇲', group: 'H', confederation: 'CAF' },
  { id: 32, name: 'Polonia',      code: 'POL', flag: '🇵🇱', group: 'H', confederation: 'UEFA' },
  // Grupo I
  { id: 33, name: 'Croacia',      code: 'CRO', flag: '🇭🇷', group: 'I', confederation: 'UEFA' },
  { id: 34, name: 'Bolivia',      code: 'BOL', flag: '🇧🇴', group: 'I', confederation: 'CONMEBOL' },
  { id: 35, name: 'Egipto',       code: 'EGY', flag: '🇪🇬', group: 'I', confederation: 'CAF' },
  { id: 36, name: 'Grecia',       code: 'GRE', flag: '🇬🇷', group: 'I', confederation: 'UEFA' },
  // Grupo J
  { id: 37, name: 'Dinamarca',    code: 'DEN', flag: '🇩🇰', group: 'J', confederation: 'UEFA' },
  { id: 38, name: 'Venezuela',    code: 'VEN', flag: '🇻🇪', group: 'J', confederation: 'CONMEBOL' },
  { id: 39, name: 'Argelia',      code: 'ALG', flag: '🇩🇿', group: 'J', confederation: 'CAF' },
  { id: 40, name: 'Indonesia',    code: 'IDN', flag: '🇮🇩', group: 'J', confederation: 'AFC' },
  // Grupo K
  { id: 41, name: 'Austria',      code: 'AUT', flag: '🇦🇹', group: 'K', confederation: 'UEFA' },
  { id: 42, name: 'Paraguay',     code: 'PAR', flag: '🇵🇾', group: 'K', confederation: 'CONMEBOL' },
  { id: 43, name: 'Turquía',      code: 'TUR', flag: '🇹🇷', group: 'K', confederation: 'UEFA' },
  { id: 44, name: 'Nueva Zelanda', code: 'NZL', flag: '🇳🇿', group: 'K', confederation: 'OFC' },
  // Grupo L
  { id: 45, name: 'Canadá',       code: 'CAN', flag: '🇨🇦', group: 'L', confederation: 'CONCACAF' },
  { id: 46, name: 'Honduras',     code: 'HON', flag: '🇭🇳', group: 'L', confederation: 'CONCACAF' },
  { id: 47, name: 'Qatar',        code: 'QAT', flag: '🇶🇦', group: 'L', confederation: 'AFC' },
  { id: 48, name: 'Eslovenia',    code: 'SVN', flag: '🇸🇮', group: 'L', confederation: 'UEFA' },
];
